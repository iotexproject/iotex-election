...
//
// Solidity: function buckets( uint256) constant returns(canName bytes12, stakedAmount uint256, stakeDuration uint256, stakeStartTime uint256, nonDecay bool, unstakeStartTime uint256, bucketOwner address, createTime uint256, prev uint256, next uint256)
...
//
// Solidity: function getActiveBucketCreateTimes(_prevIndex uint256, _limit uint256) constant returns(count uint256, indexes uint256[], createTimes uint256[])
...
//
// Solidity: function getActiveBucketIdx(_prevIndex uint256, _limit uint256) constant returns(count uint256, indexes uint256[])
...
//
// Solidity: function getActiveBuckets(_prevIndex uint256, _limit uint256) constant returns(count uint256, indexes uint256[], stakeStartTimes uint256[], stakeDurations uint256[], decays bool[], stakedAmounts uint256[], canNames bytes12[], owners address[])
...
//
// Solidity: function getBucketIndexesByAddress(_owner address) constant returns(uint256[])
...
//
// Solidity: function createBucket(_canName bytes12, _amount uint256, _stakeDuration uint256, _nonDecay bool, _data bytes) returns(uint256)
...
//
// Solidity: function restake(_bucketIndex uint256, _stakeDuration uint256, _nonDecay bool, _data bytes) returns()
...
//
// Solidity: function revote(_bucketIndex uint256, _canName bytes12, _data bytes) returns()
...
//
// Solidity: function setBucketOwner(_bucketIndex uint256, _newOwner address, _data bytes) returns()
...
//
// Solidity: function unstake(_bucketIndex uint256, _data bytes) returns()
...
//
// Solidity: function withdraw(_bucketIndex uint256, _data bytes) returns()
...
//
// Solidity: e BucketCreated(bucketIndex uint256, canName bytes12, amount uint256, stakeDuration uint256, nonDecay bool, data bytes)
...
//
// Solidity: e BucketUnstake(bucketIndex uint256, canName bytes12, amount uint256, data bytes)
...
//
// Solidity: e BucketUpdated(bucketIndex uint256, canName bytes12, stakeDuration uint256, stakeStartTime uint256, nonDecay bool, bucketOwner address, data bytes)
...
//
// Solidity: e BucketWithdraw(bucketIndex uint256, canName bytes12, amount uint256, data bytes)
